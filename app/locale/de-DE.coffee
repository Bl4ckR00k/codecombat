...
#    victory_new_hero: "New Hero"
    victory_viking_code_school: "Heiliger Bimbam, das war ein schweres Level, dass du gerade gemeistert hast! Wenn du noch kein Softwareentwickler bist, solltest du darüber nachdenken. Du wurdest zum Eilverfahren für die Aufnahme an der Viking Code School eingeschrieben, wo du deine Skills auf den nächsten Level bringen kannst und ein professioneller Web-Developer in 14 Wochen werden kannst."
...
#    victory_no_progress_for_teachers: "Progress is not saved for teachers. But, you can add a student account to your classroom for yourself."
    ...
    infinite_loop_description: "Der eingegebene Code für die Erschaffung dieser Welt findet kein Ende. Er ist entweder sehr langsam oder hat eine unendliche Schleife. Oder es gibt einen Bug. Du kannst entweder versuchen den Code noch einmal zu starten oder den Code auf den Ursprungscode zurücksetzen. Falls das nicht hilft, lass es uns bitte wissen."
